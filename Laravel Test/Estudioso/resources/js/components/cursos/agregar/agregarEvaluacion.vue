            ...
            <div class="row justify-content-center">
                <div class="col-9">
                    <div class="card">
                        ...
                        <div
                            class="card-body justify-content-center border border-secondary"
                        ...
                        >
                            ...
                            >
                                ...
                                />
                                <span class="text-danger ml-2 text-center" v-if="computedNombre">
                                    <b>
                                ...
                                <div class="d-flex align-items-center">
                                    <input
                                        ...
                                        name="porcEv"
                                        v-model.number="porcInput"
                                        :class="computedPorc"
                                    />
                                    <span class="ml-2">%</span>
                                </div>
                                <span
                                    class="text-danger ml-2 text-center"
                                    v-if="computedPorc === 'is-invalid'"
                                >
                                    <b>El porcentaje de las evaluaciones no debe sumar más de 100% ni ser menor a 1%</b>
                                </span>
...
export default {
    ...
    computed: {
        computedPorc() {
            if (parseInt(this.porc) + parseInt(this.porcInput) > 100)
                return "is-invalid";
            else if (this.porcInput < 1 && this.porcInput != null)
                return "is-invalid";
            else return "";
        },
        ...
        computedNombre() {
            if (
                this.nombreInput[0] === " " ||
                this.nombreInput[this.nombreInput.length - 1] === " "
            ) {
                return "is-invalid";
            } else {
                let i = 0;
        ...
        computedBtn() {
            if (this.porcInput < 1 && this.porcInput != null) {
                this.submitBtn = true;
