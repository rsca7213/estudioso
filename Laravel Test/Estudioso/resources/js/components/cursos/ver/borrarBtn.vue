<template>
    <span>
        <button class="btn btn-danger btn-lg ml-2 mr-4" data-toggle="modal" :data-target="modal_target"> Borrar </button> 
                    ...
                    <div>
                        ...
                        <div class="modal-body">
                            <div class="row text-center">
                                <p class="ml-3"> <b> ¿Está seguro que desea borrar el curso? </b> </p>
                                <p class="ml-4"> <b>Curso: </b> <span v-text="this.c_n"> </span> </p>
                            </div>
                        </div>
